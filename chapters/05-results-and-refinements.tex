...
exclusively from the Hypo-Stage artifact records, and literal statements from
the active-listening sessions are reported only when they add evidence beyond
...
only that a hypothesis be \emph{falsifiable}---refutable and testable---and
recommends writing it as a simple, direct statement of the team's current belief
