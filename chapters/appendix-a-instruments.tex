...
interview approach recommended for flexible designs \citep{robson2016}.
...
team at the end of the observation period (one session per team, two in total;
approximately 20--30 minutes each). They were not audio-recorded or transcribed;
see Section~\ref{subsec:active-listening}.
