...
\keywords{Software Architecture, Architectural Uncertainty, Hypotheses Engineering, ArchHypo, Arch-Stage, Empirical Evaluation}

\palavraschave{Arquitetura de Software, Incerteza Arquitetural, Engenharia de Hipóteses, ArchHypo, Arch-Stage, Avaliação Empírica}
...
Arch-Stage, a support tool for the ArchHypo technique, by applying it with multiple
...
avalia e refina empiricamente o Arch-Stage, uma ferramenta de apoio à técnica
