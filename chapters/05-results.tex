...
\emph{Results} sections (Sections~\ref{sec:results-rq1}--\ref{sec:results-rq4}) report
how teams used Arch-Stage, the architectural uncertainties they managed, and the
...
Arch-Stage or its usage guidelines, linked to the specific observation that motivated it
and to the research question it helps answer. This integrated structure reflects the
...
% TODO: Report patterns of Arch-Stage and ArchHypo use.
...
% TODO: Characterize architectural uncertainties managed via Arch-Stage.

\section{Empirical Results (RQ4)}
