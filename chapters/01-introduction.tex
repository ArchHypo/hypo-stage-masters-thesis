...
Grounded in these studies' contributions, an initial version of Hypo-Stage --- a support tool designed to help teams apply the ArchHypo technique in practice --- was developed as prior work \citep{correa2025}; this thesis takes that tool as its starting artifact rather than as one of its contributions.
