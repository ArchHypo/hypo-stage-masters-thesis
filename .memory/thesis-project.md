...
- **Deposit snapshots (2026-08-02):** `archive/thesis-deposit-corrected-20260802.pdf` (corrected version for Biblioteca Digital USP); `archive/thesis-deposit-original-20260802.pdf` (canonical tracked deposit aligned with current `thesis.pdf`).
...
- Corrected-version refresh: **`thesis-deposit-corrected-20260802.pdf`** and **`thesis-deposit-original-20260802.pdf`** (2 August 2026; includes T28 initial-tool screenshot).
